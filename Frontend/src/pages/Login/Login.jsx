...
const Login = () => {
  ...
  const handleCardClick = (userType) => {
    // Navigate to respective login pages - you can customize these routes
    switch (userType) {
      case "traveler":
      ...
      <div className={styles.content}>
        ...
        <div className={styles.cardsContainer}>
          ...
          >
            ...
            <p className={styles.cardDescription}>
              We provide reliable travel information to promote tourism and
              local growth
            </p>
            <div className={styles.cardFooter}>
              <span className={styles.clickText}>Click to Continue</span>
          ...
          >
            ...
            <p className={styles.cardDescription}>
              Showcase your services, connect with travelers, and grow your
              tourism business
            </p>
            <div className={styles.cardFooter}>
              <span className={styles.clickText}>Click to Continue</span>
